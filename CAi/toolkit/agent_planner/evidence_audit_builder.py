    ...
    *,
    ...
    for spec in _CLAIM_SPECS:
        ...
        rows.append(
            {
                **spec,
                "benchmark_id": first.get("benchmark_id") or first.get("source_benchmark_id") or "--",
                "dataset": first.get("dataset") or "--",
                "execution_mode": first.get("execution_mode") or "--",
                "row_count": len(view_rows),
                "result_path": artifact.get("json") or artifact.get("csv") or "--",
            }
        )
