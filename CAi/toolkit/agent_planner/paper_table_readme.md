...
```bash
python -m CAi.toolkit.agent_planner.master_table_builder --output-dir logs/baseline_runs/master_baseline_table
python -m CAi.toolkit.agent_planner.latex_table_export --input-dir logs/baseline_runs/master_baseline_table --output-dir logs/baseline_runs/master_baseline_table/latex
```
