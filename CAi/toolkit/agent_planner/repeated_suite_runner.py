...
from .baseline_planners import FULL_COPILOT, RULE_BASED_PLANNER, SUPPORTED_BASELINES
...
def run_repeated_baseline_suite(
    ...
    *,
    ...
    baselines = tuple(planner_baselines or (RULE_BASED_PLANNER, FULL_COPILOT))
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Repeat a CAi planner baseline suite and aggregate statistics.")
    ...
    parser.add_argument(
        ...
        default=[RULE_BASED_PLANNER, FULL_COPILOT],
    )
