# FullCopilot Architecture

## Overview

FullCopilot keeps the `CAi/` Python package path for backward compatibility,
while adding a trustworthy planning and verification layer for biomedical
tool-using agents. The architecture is designed around composition:
