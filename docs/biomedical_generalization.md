...
EGVR-Agent is positioned as a trustworthy biomedical tool-using agent
...
```bash
python -m egvr.biomedical_benchmark_runner \
  --benchmark egvr/benchmarks/clinical_trial_outcome_prediction_v2_offline.jsonl \
  --output /tmp/clinical_trial_v2_summary.json

python -m egvr.biomedical_benchmark_runner \
  --benchmark egvr/benchmarks/drug_target_evidence_v2_offline.jsonl \
...
```bash
python -m egvr.biomedical_generalization_table \
  --benchmark egvr/benchmarks/clinical_trial_outcome_prediction_v2_offline.jsonl \
  --benchmark egvr/benchmarks/drug_target_evidence_v2_offline.jsonl \
