...
from .baseline_planners import DEFAULT_PUBLIC_BASELINES, SUPPORTED_BASELINES
...
def run_baseline_suite(
    ...
    *,
    ...
    baselines = _validate_baselines(planner_baselines or DEFAULT_PUBLIC_BASELINES)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run multiple EGVR planner baselines for one benchmark JSONL.")
    ...
    parser.add_argument(
        ...
        default=list(DEFAULT_PUBLIC_BASELINES),
