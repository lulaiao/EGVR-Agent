"""Structured evidence-tool registry for planning and benchmarking."""
...
class EvidenceToolRegistry:
    """Small in-memory registry for typed tool capabilities and dependencies."""
...
DEFAULT_TOOL_METADATA: tuple[ToolMetadata, ...] = (
    ToolMetadata(
        ...
        wrapper_function="egvr.adapters.molecular.generate_molecules_for_pocket",
    ...
    ToolMetadata(
        ...
        wrapper_function="egvr.adapters.molecular.generate_molecules_reinvent4_denovo",
    ...
    ToolMetadata(
        ...
        wrapper_function="egvr.adapters.molecular.generate_molecules_reinvent4_mol2mol",
    ...
    ToolMetadata(
        ...
        wrapper_function="egvr.adapters.molecular.generate_molecules_reinvent4_libinvent",
    ...
    ToolMetadata(
        ...
        wrapper_function="egvr.adapters.molecular.generate_scaffold_analogs",
    ...
    ToolMetadata(
        ...
        wrapper_function="egvr.adapters.molecular.generate_libinvent_decorations",
    ...
    ToolMetadata(
        ...
        wrapper_function="egvr.adapters.molecular.perform_molecular_docking_vina",
    ...
    ToolMetadata(
        ...
        wrapper_function="egvr.adapters.molecular.calculate_scscore",
    ...
    ToolMetadata(
        ...
        wrapper_function="egvr.adapters.molecular.predict_molecule_toxicity",
    ...
    ToolMetadata(
        ...
        wrapper_function="egvr.adapters.molecular.predict_antibacterial_pmic",
    ...
    ToolMetadata(
        ...
        wrapper_function="egvr.verifier_evidence_runner.calculate_sa_scores",
    ...
    ToolMetadata(
        ...
        wrapper_function="egvr.verifier_evidence_runner.collect_posebusters_evidence",
    ...
    ToolMetadata(
        ...
        wrapper_function="egvr.rdkit_property_runner.calculate_rdkit_properties",
...
def build_default_tool_registry() -> EvidenceToolRegistry:
    ...
    return EvidenceToolRegistry(DEFAULT_TOOL_METADATA)
